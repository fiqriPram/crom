...
export const roms: Rom[] = [
  ...
  },
  {
    ...
    longDescription:
      "Manjaro is a user-friendly Linux distribution based on Arch Linux that brings the power and flexibility of Arch to everyday users. It features automatic hardware detection, a curated set of preinstalled applications, and multiple official desktop environments including KDE Plasma, GNOME and Xfce. Manjaro uses its own stable, testing and unstable branches to deliver tested and verified package updates, giving users a balance between bleeding-edge software and system stability. With a welcoming community and excellent documentation, Manjaro is the perfect bridge for users who want the Arch experience without the steep learning curve.",
    benefits: [
      "Arch-based with a user-friendly approach",
      "Automatic hardware detection and driver setup",
      "Tested and curated package updates for stability",
      "Multiple official desktop environments",
      "Welcoming community and excellent documentation",
    ],
    features: [
      "Official KDE Plasma, GNOME & Xfce editions",
      "Manjaro Settings Manager for hardware config",
      "MHWD — automatic driver management",
      "Arch User Repository (AUR) access",
      "Pamac graphical package manager",
      "Rolling-release with stable package branches",
    ],
    color: "text-zen-green",
    bgColor: "bg-zen-green/10",
    borderColor: "border-zen-green/30",
    ...
    icon: "/crom-logos/linux/manjaro.png",
  },
  {
    slug: "artixlinux",
    name: "Artix Linux",
    ...
    longDescription:
      "Artix Linux is an independently developed, rolling-release Linux distribution derived from Arch Linux. Its defining feature is the choice of an open init system — runit, OpenRC or s6 — instead of systemd, giving users who prefer minimalist and transparent system management a clean Arch-like base without bloat. As a rolling release, Artix always provides recent packages, and it retains full compatibility with Arch's ecosystem and much of the Arch User Repository. For users who value simplicity, speed and init system freedom, Artix delivers a lean and highly customizable Arch experience.",
    benefits: [
      "Rolling release with up-to-date software",
      "Choice of runit, OpenRC or s6 (no systemd)",
      "Fast, lightweight and minimal by design",
      "Arch-based — near-full AUR compatibility",
      "Independent, community-driven and transparent",
    ],
    features: [
      "Multiple open init systems (runit, OpenRC, s6)",
      "Rolling-release model from Arch",
      "pacman package manager with AUR access",
      "Minimal base that is fully customizable",
      "Available for multiple architectures and ISOs",
  ...
  },
  {
    ...
    name: "Fedora",
    type: "linux",
    tagline: "An innovative, community-driven Linux distro",
    description:
      "A fast, stable, and powerful Linux distribution with cutting-edge software, sponsored by Red Hat and built by the Fedora community.",
    longDescription:
      "Fedora is a community-driven Linux distribution sponsored by Red Hat, known for being at the forefront of open-source innovation. It provides the latest software, including new kernel versions, desktop environments and development tools, while maintaining a strong focus on stability and security. Fedora serves as the upstream for Red Hat Enterprise Linux (RHEL) and offers several editions for different use cases, from the GNOME-based Fedora Workstation to Fedora Server and Fedora IoT. With fast release cycles, excellent hardware support and a thriving community, Fedora is an ideal choice for both developers and everyday users who want to run the latest open-source software.",
    benefits: [
      "Cutting-edge software with short release cycles",
      "Strong security features including SELinux by default",
      "Excellent developer tools and container support",
      "Upstream for Red Hat Enterprise Linux (RHEL)",
      "Multiple editions — Workstation, Server, IoT and more",
    ],
    features: [
      "Short release cycle — new versions every 6 months",
      "SELinux security enforced by default",
      "GNOME desktop with Vanilla-first experience",
      "dnf package manager with RPM packages",
      "Excellent hardware and driver support",
      "Community-driven with strong Red Hat backing",
    ],
    color: "text-zen-blue",
    bgColor: "bg-zen-blue/10",
    borderColor: "border-zen-blue/30",
    ...
    icon: "/crom-logos/linux/fedora.png",
  },
  {
    slug: "nixos",
    name: "NixOS",
  ...
  },
  {
    ...
    name: "Zorin OS",
    type: "linux",
    tagline: "The alternative to Windows & macOS",
    description:
      "A free, Ubuntu-based Linux distribution designed to make your computer faster, more powerful, secure and privacy-respecting — while staying familiar and easy to use.",
    longDescription:
      "Zorin OS is an Ubuntu-based Linux distribution built as a user-friendly alternative to Windows and macOS. It features a familiar desktop with layouts that can feel like Windows, macOS or Linux via the Zorin Appearance app, runs lightning-quick even on computers as old as 15 years, and respects your privacy by collecting no personal data. With built-in Windows App Support, a huge Software store, gaming-ready graphics drivers and the Zorin Connect phone integration, it is an excellent choice for newcomers switching from Windows.",
    benefits: [
      "Familiar desktop — switch from Windows or macOS with no learning curve",
      "Fast and lightweight — revives PCs as old as 15 years",
      "Privacy-respecting — no tracking or personal data collection",
      "Ubuntu-based with long-term security updates",
      "Free Core edition with optional Pro upgrade",
    ],
    features: [
      "Zorin Appearance with Windows/macOS layouts",
      "Windows App Support (.exe & .msi compatible)",
      "Built-in Software store with thousands of apps",
      "Gaming-ready NVIDIA, AMD & Intel drivers",
      "Zorin Connect phone integration",
      "Translated into 100+ languages with accessibility tools",
    ],
    color: "text-zen-sky",
    bgColor: "bg-zen-sky/10",
    borderColor: "border-zen-sky/30",
    ringColor: "ring-zen-sky/30",
    url: "https://zorin.com/",
    icon: "/crom-logos/linux/zorin.png",
  },
  {
    slug: "elementary",
    name: "elementary OS",
    type: "linux",
    tagline: "Thoughtful, capable & ethical computing",
    description:
      "A polished, Ubuntu-based Linux distribution focused on thoughtful design, privacy and everyday usability — with curated apps and no bloatware.",
    longDescription:
      "elementary OS is an Ubuntu-based Linux distribution built around thoughtful, capable and ethical computing. It ships with the Pantheon desktop and a carefully considered set of native apps for everyday needs, so you spend more time using your computer and less time cleaning up bloatware. Privacy is front and center: no advertising deals, no sensitive data collection, permission prompts with per-app control, and tattle-tale indicators when apps use your mic or excess energy. Funded pay-what-you-can via AppCenter, it is fast, lightweight and keyboard-friendly for newcomers and power users alike.",
    benefits: [
      "Beautiful, thoughtful Pantheon desktop out of the box",
      "Privacy-respecting — no ads or data collection",
      "Curated native apps with no bloatware",
      "Ubuntu-based with long-term support",
      "Pay-what-you-can funding that supports indie developers",
    ],
    features: [
      "Pantheon desktop with Multitasking View",
      "AppCenter pay-what-you-can app store",
      "Granular privacy permissions & tattle-tale indicators",
      "Picture-in-Picture & Do Not Disturb focus tools",
      "Screen Time & parental controls",
      "Keyboard-friendly with powerful shortcuts",
    ],
    color: "text-zen-blue",
    bgColor: "bg-zen-blue/10",
    borderColor: "border-zen-blue/30",
    ...
    icon: "/crom-logos/linux/elementary.png",
  },
  {
    slug: "opensuse",
    name: "openSUSE",
    type: "linux",
    tagline: "Free OS for desktops, servers & containers",
    description:
      "A community-driven Linux project offering free, polished operating systems for desktops, servers and containers — in stable Leap and rolling Tumbleweed flavors.",
    longDescription:
      "openSUSE is a long-running community Linux project backed by SUSE, producing free operating systems for desktops, servers and containers. Pick your pace: Leap for a stable, predictable release, or Tumbleweed for a thoroughly tested rolling release. The YaST control center, Btrfs snapshots with easy rollback, the Open Build Service and openQA testing infrastructure make openSUSE powerful yet approachable — free to use with no upsells, ads or mandatory accounts.",
    benefits: [
      "Two flavors — stable Leap or rolling Tumbleweed",
      "Free forever — no upsells, ads or mandatory accounts",
      "Btrfs snapshots with easy system rollback",
      "YaST — powerful graphical system administration",
      "Backed by SUSE with a strong global community",
    ],
    features: [
      "Leap (stable) & Tumbleweed (rolling) editions",
      "KDE, GNOME & Xfce desktop choices",
      "YaST control center & one-click installs",
      "Btrfs snapshots, full disk encryption & Secure Boot",
      "Open Build Service with huge package collection",
      "Immutable MicroOS / Aeon / Kalpa variants",
    ],
    color: "text-zen-lime",
    bgColor: "bg-zen-lime/10",
    borderColor: "border-zen-lime/30",
    ...
    icon: "/crom-logos/linux/opensuse.png",
  },
  {
    slug: "slackware",
    name: "Slackware",
    type: "linux",
    tagline: "The oldest actively maintained Linux distro",
    description:
      "The longest-running Linux distribution still in active development — simple, stable and UNIX-like, built for users who want full control and transparency.",
    longDescription:
      "Slackware is the oldest Linux distribution under active maintenance, first released in 1993 by Patrick Volkerding. It follows a philosophy of simplicity, stability and UNIX-likeness: no complex dependency resolution magic, no heavy-handed defaults — just vanilla packages and transparent configuration you fully control. The latest stable release, Slackware 15.0, ships a modern 5.15 LTS kernel with the KDE Plasma desktop and Wayland support. It is the distro of choice for purists, learners and veterans who want to understand exactly what their system is doing.",
    benefits: [
      "Legendary stability — conservative, thoroughly tested releases",
      "Simple & transparent — vanilla packages, no hidden magic",
      "UNIX-like design that teaches you how Linux really works",
      "Lightweight with full control over every component",
      "Running continuously since 1993 with a loyal community",
    ],
    features: [
      "Latest stable release Slackware 15.0",
      "KDE Plasma desktop with Wayland support",
      "Simple pkgtool package management",
      "SlackBuilds.org for extra software",
      "Slackware Live Edition (DVD/USB trial)",
      "ARM port & extensive documentation",
    ],
    color: "text-zen-gray",
    bgColor: "bg-zen-gray/10",
    borderColor: "border-zen-gray/30",
    ...
    icon: "/crom-logos/linux/slackware.png",
  },
  {
    slug: "orangefox",
    name: "OrangeFox",
